...
final getHistoryOfChatUserUsecaseProvider =
    Provider<GetHistoryOfChatUserUsecase>((ref) {
  final fireCloudStore = ref.watch(firebaseCloudStoreProvider);
  final baseSharePreference = ref.watch(baseSharePreferenceProvider);
  return GetHistoryOfChatUserUsecase(
    ref,
    fireCloudStore,
    baseSharePreference,
  );
...
class GetHistoryOfChatUserUsecase
      ...
      for (final item in collect.reversed) {
        ...
        requestChatList.add(
          ChatWithPharmacyResponse(
            ...
            fullName: _user['fullName'], // fullName: _user['nameStore'],
            chatImg: "ไฟล์รูปภาพ",
            nameStore: _pharmacyStore['nameStore'],
            licensePharmacy: _pharmacyStore['licensePharmacy'],
            phoneStore: _pharmacyStore['phoneStore'],
